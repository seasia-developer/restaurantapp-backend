...
use App\Http\Controllers\Api\Listing\ListingController;
    ...
    if (isset($result['listing_bat']['prefilledfield'])) {
        $prefilledfield = $result['listing_bat']['prefilledfield'];
    }

    if (isset($result['listing_bat']['grossSales'])) {
        $grossSales = $result['listing_bat']['grossSales'];
    }
    ...
    if (isset( $result['listing_bat']['grossSales'])) {
        if ((int) $result['listing_bat']['grossSales'] > 0) {
            ...
            $grossMargin = $batMap->getGrossMargin($grossSales, $totalCOGS);
            ...
            $totalAddBacks = $batMap->getTotalAddBacks($ownerSalary, $benefits,
             $interestExpense, $depreciation, $postageDelivery, $other);
    ...
    if (isset($result['listing_bat']['grossSales_2'])) {
        if ((int)$result['listing_bat']['grossSales_2'] > 0) {
            ...
            $totalAddBacks1 = $batMap->getTotalAddBacks($result['listing_bat']['postageDelivery_2'], $result['listing_bat']['benefits'], $result['listing_bat']['interestExpense_4'], $result['listing_bat']['depreciation_4'], $result['listing_bat']['ownerPersonalExpenses_4'], $result['listing_bat']['other_2']);
    ...
    if (isset($result['listing_equipment']['equiptext']  )){
        $equiptext = $result['listing_equipment']['equiptext'];
    ...
    if(isset($result['listing_occupancy_leases']['ltotalmonthrent'])){
        $dataArr = $result['listing_occupancy_leases']['ltotalmonthrent'];
    } else {
        $dataArr = '';
    }
    if($dataArr != ''){
    ...
    if(isset($result['listing_occupancy_leases']['linsidesqt'])){
        $sqtArr = $result['listing_occupancy_leases']['linsidesqt'];
    } else {
        $sqtArr = '';
    }
    if($sqtArr != ''){
                ...
                <table style="width: 100%; box-sizing: border-box;">
                    ...
                    <tr>
                        <td colspan="2"
                            ...
                            &nbsp; @if(isset($result['agent']['lastname'])) {{ $result['agent']['lastname'] }} @endif
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"
            ...
            <table id="page10" width="100%" border="0" cellspacing="0" cellpadding="0" nobr="true">
                ...
                <tr>
                    ...
                    <td width="94%" bgcolor="white"
                        ...
                        @if(isset($result['bheadlinead'])) {!! $result['bheadlinead'] !!} @endif</td>
                </tr>
                <tr>
                    <td colspan="2" height="10" bgcolor="white"></td>
                </tr>
                <tr>
                    ...
                    <td width="94%" bgcolor="white"
                        ...
                        @if(isset($result['bdetailedad'])) {!! $result['bdetailedad'] !!} @endif </td>
                </tr>
                <tr>
                    <td colspan="2" height="10" bgcolor="white"></td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                ...
                <tr>
                    ...
                    <td width="97%"
                        ...
                        This business is offered at @if(isset($result['bsaleprice'])) $ {!! $result['bsaleprice'] !!} @else $0
                        @endif</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="97%">
                    @if(isset( $result['listing_media']['img_file']))
                        <img src="{{ url('storage/images/list/main_images/'.$result['listing_media']['img_file']) }}" alt="blog"
                ...
                <tr>
                    ...
                    <td width="97%"
                        style="font-size: 18px; line-height: 30px; font-family: 'Arimo', sans-serif; color: #000; text-align: left; font-weight: bold;">
                        @if(isset($result['listing_headlines']['add_more_detail'])) {!! $result['listing_headlines']['add_more_detail'] !!} @endif
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="page6" style="page-break-before: always;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" nobr="true">
                ...
                <tr>
                    ...
                    <td style="width: 58%;" align="middle" bgcolor="white">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" nobr="true">
                            ...
                            <tr>
                                <td width="100%"
                                    style="font-size: 18px; line-height: 30px; font-family: 'Arimo', sans-serif; color: #000; text-align: left;">
                                    Established: @if(isset($result['listing_ops']['yearestablish'] )) {!! $result['listing_ops']['yearestablish'] !!} @endif
                                </td>
                            </tr>  
                            <tr>  
                                <td width="100%"
                                    style="font-size: 18px; line-height: 30px; font-family: 'Arimo', sans-serif; color: #000; text-align: left;">
                                    Years Owned by Current Owner: @if(isset($result['listing_ops']['currentowner'])) {!! $result['listing_ops']['currentowner']
                                    !!} @endif </td>
                            </tr>
                            <tr>
                                <td width="100%"
                                    style="font-size: 18px; line-height: 30px; font-family: 'Arimo', sans-serif; color: #000; text-align: left;">
                                    Reason for Selling: @if(isset($result['listing_bat']['reasonForSelling'])) {!! $result['listing_bat']['reasonForSelling']
                                    !!} @endif</td>
                            </tr>
                        </table>
                    </td>
                    ...
                    @if(isset( $result['listing_media']['img_file']))
                        <img align="middle" src="{{ url('storage/images/list/main_images/'.$result['listing_media']['img_file'] }}"
                    ...
                    <td colspan="2" style="width: 96%;" align="middle" bgcolor="white">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" nobr="true">
                            ...
                            <tr>
                                <td width="100%"
                                    style="font-size: 18px; line-height: 30px; font-family: 'Arimo', sans-serif; color: #000; text-align: left;">
                                    Marketing Fee: @if(isset($result['listing_bat']['batFranchise'])) {!! $result['listing_bat']['batFranchise'] !!}% @else 0%
                                    @endif</td>
                            </tr>
                            <tr>
                                <td width="100%"
                                    style="font-size: 18px; line-height: 30px; font-family: 'Arimo', sans-serif; color: #000; text-align: left;">
                                    Royalty Fee: @if(isset($result['listing_bat']['royaltyFees'])) {!! $result['listing_bat']['royaltyFees'] !!}% @else 0%
                                    @endif</td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table style="text-align: center" width="100%" border="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td width="100%"
                                                ...
                                                @if(isset($result['listing_ops']['noparttimeemp'])) {!! $result['listing_ops']['noparttimeemp'] !!} @endif</td>
                                        </tr>
                                        <tr>
                                            <td width="100%"
                                                style="font-size: 16px; line-height: 18px; font-family: 'Arimo', sans-serif; color: #000; text-align: center; font-style: italic;">
                                    ...
                                    <table style="text-align: center" width="100%" border="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td width="100%"
                                                ...
                                                @if(isset($result['listing_ops']['nooutsideeats'])) {!! $result['listing_ops']['nooutsideeats'] !!} @endif</td>
                                        </tr>
                                        <tr>
                                            <td width="100%"
                                                style="font-size: 16px; line-height: 18px; font-family: 'Arimo', sans-serif; color: #000; text-align: center; font-style: italic;">
                                ...
                                <td style="width: 150px;  text-align: center;">
                                    <table style="text-align: center" width="100%" border="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td width="100%"
                                                style="font-size: 22px; line-height: 28px; font-family: 'Arimo', sans-serif; color: #000; text-align: center; font-weight: bold;">
                                                @if(isset($result['listing_ops']['liquorlicensetyp'])) {!! $result['listing_ops']['liquorlicensetyp'] !!}
                                                @endif</td>
                                        </tr>
                                        <tr>
                                            <td width="100%"
                                ...
                                <td style="width: 150px;  text-align: center;">
                                    <table style="text-align: center" width="100%" border="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td width="100%"
                                                style="font-size: 22px; line-height: 28px; font-family: 'Arimo', sans-serif; color: #000; text-align: center; font-weight: bold;">
                                                @if(isset($result['listing_ops']['hoodsystem'])) {!! $result['listing_ops']['hoodsystem'] !!} @endif</td>
                                        </tr>
                                        <tr>
                                            <td width="100%"
                                                style="font-size: 16px; line-height: 18px; font-family: 'Arimo', sans-serif; color: #000; text-align: center; font-style: italic;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 30%; text-align: center">
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="color: #fff; font-size: 13px; line-height: 13px; font-family: 'Arimo', sans-serif; text-align: center;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0px">
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                @if(isset($result['listing_ops']['currentowner'])) {!! $result['listing_ops']['currentowner'] !!} @endif</td>
                                        </tr>
                                        <tr>
                                ...
                                <td style="width: 98%;">
                                    <table width="100%" cellpadding="0" cellspacing="0px">
                                        ...
                                        <tr>
                                            <td
                                                style="font-family: 'Arimo', sans-serif; font-size: 16px; color: #000; line-height: 13px;">
                                                @if(isset($result['listing_bat']['hoursWorkedByOwner'])) {!! $result['listing_bat']['hoursWorkedByOwner'] !!}
                                                @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="height: 40px;"></td>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center; width: 100%;">
                                    <img src="{{ public_path('assets/images/print_pdf/sale.png') }}" alt="owner" style="width: 220px; height: 220px;" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="3" bgcolor="white">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="width: 2%;"></td>
                                <td style="width: 96%; font-family: 'Arimo', sans-serif; font-size:16px; line-height:22px; color: #000;">
                                    Remember that
                                    ...
                                    next step, the Buyer and Seller meeting!
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" height="4"></td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="text-align:left; color:#ff0606; font-family:'Arimo', sans-serif; font-size:48px; line-height:60px; padding-bottom:20px;">
                            ...
                            <tr>
                                <td style="text-align: center; width: 100%;">
                                    <img src="{{ public_path('assets/images/print_pdf/kitchens.png') }}" alt="owner" style="width: 309px; height: 194px;" />
                                </td>
                            </tr>
                            <tr>
                                <td height="30px"></td>
