...
class AdManager extends Model
{
    ...
    {
        return $this->belongsTo(Agents::class, 'uid', 'id');
    }

    public function state()
    {
        return $this->belongsTo(ListingState::class, 'state', 'short_code');
    }
}
